  ...
  return (
    <>
      ...
      >
        ...
        <div className="fixed left-0 top-[100dvh] flex w-full max-w-[100vw] -translate-y-full flex-col-reverse gap-2 bg-[linear-gradient(to_top,theme(colors.neutral.700/50%),theme(colors.neutral.50/0%))] px-5 pb-5 md:flex-row md:gap-4 md:p-12">
          <PurchaseSlider />
          <ShoppingCart />
        </div>
      </div>
